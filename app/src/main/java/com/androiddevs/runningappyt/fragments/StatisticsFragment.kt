...
import com.androiddevs.runningappyt.ui.CustomMarkerView
    ...
    private fun subscribeToObservers(){
        ...
        viewModel.totalAvgSpeed.observe(viewLifecycleOwner, Observer {
            it?.let {
                ...
                val totalSpeedString="${totalSpeed}km/h"
                tvAverageSpeed.text=totalSpeedString
            }
        })
        ...
        viewModel.totalDistance.observe(viewLifecycleOwner, Observer {
            it?.let {
                ...
                tvTotalDistance.text=distanceInString
            }
        })
