...
import com.androiddevs.runningappyt.other.Constants.REQUEST_LOCATION_PERMISSION
...
class RunFragment:Fragment(R.layout.fragment_run),EasyPermissions.PermissionCallbacks {
    ...
    private fun setupRecyclerView(){
        rvRuns.apply {
            ...
            rvRuns.addItemDecoration(DividerItemDecoration(requireContext(), DividerItemDecoration.VERTICAL))
        }
        ...
        val itemTouchHelperCallback= object:
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                val removedItem = runAdapter.differ.currentList[position]

                viewModel.deleteRun(removedItem)

                Snackbar.make(viewHolder.itemView, "Item deleted", Snackbar.LENGTH_LONG)
                    .setAction("UNDO") {
                        viewModel.insertRun(removedItem)
                    }.show()
            }
        }
        ...
        private fun requestPermissions(){
            ...
            if(Build.VERSION.SDK_INT<Build.VERSION_CODES.Q){
                EasyPermissions.requestPermissions(
                    this,
                    "You Need To Accept These Permissions",
